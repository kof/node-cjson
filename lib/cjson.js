/*
 * CJSON - inComments enabled json reader(inCommented Javascript Object Notation)
 *
...
/**
 * Remove single and multilie inComments. Make sure to
...
exports.decomment = function(str) {
    ...
    for (i = 0; i < str.length; ++i) {
        ...
        if (!inString) {
            ...
            // singleline inComment start
            if (curChar + nextChar === '//') {
                inComment = 1;
            // singleline inComment end
            } else if (inComment === 1 && curChar === '\n') {
                inComment = false;
                curChar = '';
            // multiline inComment start
            } else if (curChar + nextChar === '/*') {
                inComment = 2;
                ++i;
            // multiline inComment end
